export default function Nosotros() {
  return (
    <div className="nosotros-container">
      ...
      <div className="desarrolladores-section">
        <h3>Desarrolladores</h3>
        <div className="dev-card">
          <div className="dev-image">
            <img 
              src="/src/assets/imagenes/data_2Fproductimages_2FPlush_2FYurugaoMiniPlushie_SimpleOguri_NervousTama-chan_2F101_2507290953328440.webp" 
              alt="Sebastian"
            />
          </div>
          <div className="dev-info">
            ...
            <h5>Sebastian</h5>
            <p>Arquitecto principal detras de la pagina de Huerto Hogar, dedicado a llevar tecnología fresca al mundo del comercio de productos orgánicos.</p>
          </div>
        </div>
      </div>
    </div>
